...
def main():
    ...
    parser.add_argument('--images_dir', type=str, default="data/OTA-test"
                        , help='Path to the image file')
    parser.add_argument('--model_path', type=str, default="./output-best/model_path/OTA_efficientnet_contour_image_0_best_model.pth", help='Path to the trained model file')
    ...
    model.to(device)
    csv_save_path = 'result-test-OTA.csv'
